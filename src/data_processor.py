...
class DataProcessor:
    ...
    def __init__(self, dir_path, seq_len, test_size, cols_to_scale, cols_to_normalize, batch_size, feature_columns, label_columns):
    ...
    def feature_transformation(self, df):
    ...
    def get_data_loader(self, is_train=True):
        X_train, y_train = self._create_dataset(self.train_data if is_train else self.test_data)
